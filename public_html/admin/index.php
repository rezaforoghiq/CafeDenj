 ...
 * admin/index.php
 * -----------------------------------------------------------------------
 * صفحهٔ ورود مدیر (Login). اگر ادمین از قبل لاگین باشد، مستقیم به
 * dashboard هدایت می‌شود.
 * -----------------------------------------------------------------------
 */
...
// اگر از قبل لاگین است، نیازی به دیدن فرم ورود ندارد
if (Auth::check()) {
...
<title>ورود مدیر | کافه دنج</title>
...
<div class="login-card">
  <div class="logo-mark">د</div>
  <h1>ورود به پنل مدیریت</h1>
  <p class="sub">کافه دنج</p>

  <?php if ($error): ?>
    <div class="alert alert-danger py-2 px-3" style="font-size: 13.5px;"><?= htmlspecialchars($error, ENT_QUOTES, 'UTF-8') ?></div>
  <?php endif; ?>
